...
public class LattitudinalFertility implements TileAttribute<Double> {
	...
	public void init(int x, int y, float stepSize, Board b, Tile t) {
        ...
        double distFromEquator = Math.abs(y-b.boardHeight/2f) / (b.boardHeight/2f);
        distFromEquator = 1f - distFromEquator;
        fertility *= distFromEquator;
	}

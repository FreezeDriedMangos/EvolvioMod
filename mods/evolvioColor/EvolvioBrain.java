...
import evolvioColor.creatureAttributes.MouthHue;
...
public class EvolvioBrain implements Brain, BrainDrawer {
	...
	public void init(Creature c, Board b, String[] outputNames) {
		...
		//	neurons = tneurons;
		//}
			// the functionality of the above code will be replaced with creature.brain = passedInBrain;
	}

	@Override
	public void think(Creature c, Board b, double timeStep) {
		// TODO Auto-generated method stub
		see(c, b, timeStep);
